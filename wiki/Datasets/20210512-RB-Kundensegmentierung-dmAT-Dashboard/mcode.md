...
```m
let
    Source = Excel.Workbook(File.Contents("\\rolandberger.net\DFS\MUC\services4\bits\analytics_tools\02_Projects\dm 2021\02_Unterlagen\AT\07_Dashboard\Input\AT_DESCR_df_age_det_C12_S93_v003.xlsx"), null, true),
...
```m
let
    Source = Excel.Workbook(File.Contents("\\rolandberger.net\DFS\MUC\services4\bits\analytics_tools\02_Projects\dm 2021\02_Unterlagen\AT\07_Dashboard\Input\AT_DESCR_df_kpi_assoc_C12_S93_v003.xlsx"), null, true),
    Sheet1_Sheet = Source{[Item="Sheet1",Kind="Sheet"]}[Data],
    #"Promoted Headers" = Table.PromoteHeaders(Sheet1_Sheet, [PromoteAllScalars=true]),
...
```m
let
    Source = Excel.Workbook(File.Contents("\\rolandberger.net\DFS\MUC\services4\bits\analytics_tools\02_Projects\dm 2021\02_Unterlagen\AT\07_Dashboard\Input\AT_DESCR_df_kpi_day_C12_S93_v003.xlsx"), null, true),
    Sheet1_Sheet = Source{[Item="Sheet1",Kind="Sheet"]}[Data],
    #"Promoted Headers" = Table.PromoteHeaders(Sheet1_Sheet, [PromoteAllScalars=true]),
...
```m
let
    Source = Excel.Workbook(File.Contents("\\rolandberger.net\DFS\MUC\services4\bits\analytics_tools\02_Projects\dm 2021\02_Unterlagen\AT\07_Dashboard\Input\AT_DESCR_df_kpi_det_C12_S93_v003.xlsx"), null, true),
    Sheet1_Sheet = Source{[Item="Sheet1",Kind="Sheet"]}[Data],
    #"Promoted Headers" = Table.PromoteHeaders(Sheet1_Sheet, [PromoteAllScalars=true]),
...
```m
let
    Source = Excel.Workbook(File.Contents("\\rolandberger.net\DFS\MUC\services4\bits\analytics_tools\02_Projects\dm 2021\02_Unterlagen\AT\07_Dashboard\Input\Output_2_FH.xlsx"), null, true),
    Sheet1_Sheet = Source{[Item="Sheet1",Kind="Sheet"]}[Data],
    #"Promoted Headers" = Table.PromoteHeaders(Sheet1_Sheet, [PromoteAllScalars=true]),
...
```m
let
    Source = Excel.Workbook(File.Contents("\\rolandberger.net\DFS\MUC\services4\bits\analytics_tools\02_Projects\dm 2021\02_Unterlagen\AT\07_Dashboard\Input\AT_DESCR_df_kpi_main_C12_S93_v003.xlsx"), null, true),
    Sheet1_Sheet = Source{[Item="Sheet1",Kind="Sheet"]}[Data],
    #"Promoted Headers" = Table.PromoteHeaders(Sheet1_Sheet, [PromoteAllScalars=true]),
...
```m
let
    Source = Excel.Workbook(File.Contents("\\rolandberger.net\DFS\MUC\services4\bits\analytics_tools\02_Projects\dm 2021\02_Unterlagen\AT\07_Dashboard\Input\AT_DESCR_df_kpi_rfm_C12_S93_v003.xlsx"), null, true),
    Sheet1_Sheet = Source{[Item="Sheet1",Kind="Sheet"]}[Data],
    #"Promoted Headers" = Table.PromoteHeaders(Sheet1_Sheet, [PromoteAllScalars=true]),
...
```m
let
    Source = Excel.Workbook(File.Contents("\\rolandberger.net\DFS\MUC\services4\bits\analytics_tools\02_Projects\dm 2021\02_Unterlagen\AT\07_Dashboard\Input\AT_DESCR_df_pf_revenue_db_C12_S93_v003.xlsx"), null, true),
    Sheet1_Sheet = Source{[Item="Sheet1",Kind="Sheet"]}[Data],
    #"Promoted Headers" = Table.PromoteHeaders(Sheet1_Sheet, [PromoteAllScalars=true]),
...
```m
let
    Source = Excel.Workbook(File.Contents("\\rolandberger.net\DFS\MUC\services4\bits\analytics_tools\02_Projects\dm 2021\02_Unterlagen\AT\07_Dashboard\Input\AT_DESCR_df_top_pg_db_C12_S93_v003.xlsx"), null, true),
    Sheet1_Sheet = Source{[Item="Sheet1",Kind="Sheet"]}[Data],
    #"Promoted Headers" = Table.PromoteHeaders(Sheet1_Sheet, [PromoteAllScalars=true]),
...
```m
let
    Source = Excel.Workbook(File.Contents("\\rolandberger.net\DFS\MUC\services4\bits\analytics_tools\02_Projects\dm 2021\02_Unterlagen\HR\07_Dashboard\Input\Intervalle.xlsx"), null, true),
    Sheet1_Sheet = Source{[Item="Sheet1",Kind="Sheet"]}[Data],
    #"Promoted Headers" = Table.PromoteHeaders(Sheet1_Sheet, [PromoteAllScalars=true]),
...
```m
let
    Source = Excel.Workbook(File.Contents("\\rolandberger.net\DFS\MUC\services4\bits\analytics_tools\02_Projects\dm 2021\02_Unterlagen\HR\07_Dashboard\Input\Intervalle_equal.xlsx"), null, true),
    Sheet1_Sheet = Source{[Item="Sheet1",Kind="Sheet"]}[Data],
    #"Promoted Headers" = Table.PromoteHeaders(Sheet1_Sheet, [PromoteAllScalars=true]),
    #"Changed Type" = Table.TransformColumnTypes(#"Promoted Headers",{{"Intervall", type text}, {"Name", type text}, {"Sort_num", Int64.Type}})
in
...
```m
let
    Source = Excel.Workbook(File.Contents("\\rolandberger.net\DFS\MUC\services4\bits\analytics_tools\02_Projects\dm 2021\02_Unterlagen\HR\07_Dashboard\Input\Intervall_Lebensmittel.xlsx"), null, true),
    Sheet1_Sheet = Source{[Item="Sheet1",Kind="Sheet"]}[Data],
    #"Promoted Headers" = Table.PromoteHeaders(Sheet1_Sheet, [PromoteAllScalars=true]),
    #"Changed Type" = Table.TransformColumnTypes(#"Promoted Headers",{{"Intervall", type text}, {"Name", type text}, {"Sort_num", Int64.Type}})
in
...
```m
let
    Source = Excel.Workbook(File.Contents("\\rolandberger.net\DFS\MUC\services4\bits\analytics_tools\02_Projects\dm 2021\02_Unterlagen\HR\07_Dashboard\Input\Tage_sort.xlsx"), null, true),
    Sheet1_Sheet = Source{[Item="Sheet1",Kind="Sheet"]}[Data],
    #"Promoted Headers" = Table.PromoteHeaders(Sheet1_Sheet, [PromoteAllScalars=true]),
...
```m
let
    Source = Excel.Workbook(File.Contents("\\rolandberger.net\DFS\MUC\services4\bits\analytics_tools\02_Projects\dm 2021\02_Unterlagen\HR\07_Dashboard\Input\Alter.xlsx"), null, true),
    Sheet1_Sheet = Source{[Item="Sheet1",Kind="Sheet"]}[Data],
    #"Promoted Headers" = Table.PromoteHeaders(Sheet1_Sheet, [PromoteAllScalars=true]),
    #"Changed Type" = Table.TransformColumnTypes(#"Promoted Headers",{{"Intervall", type text}, {"Name", type text}, {"Sort_num", Int64.Type}}),
...
```m
let
    Source = Excel.Workbook(File.Contents("\\rolandberger.net\DFS\MUC\services4\bits\analytics_tools\02_Projects\dm 2021\02_Unterlagen\AT\07_Dashboard\Input\Filialtyp.xlsx"), null, true),
    Sheet1_Sheet = Source{[Item="Sheet1",Kind="Sheet"]}[Data],
...
```m
let
    Source = Excel.Workbook(File.Contents("\\rolandberger.net\DFS\MUC\services4\bits\analytics_tools\02_Projects\dm 2021\02_Unterlagen\HR\07_Dashboard\Input\Warenwelt_sort.xlsx"), null, true),
    Sheet1_Sheet = Source{[Item="Sheet1",Kind="Sheet"]}[Data],
    #"Promoted Headers" = Table.PromoteHeaders(Sheet1_Sheet, [PromoteAllScalars=true]),
...
```m
let
    Source = Excel.Workbook(File.Contents("\\rolandberger.net\DFS\MUC\services4\bits\analytics_tools\02_Projects\dm 2021\02_Unterlagen\AT\07_Dashboard\Input\Produltfaktor_sort.xlsx"), null, true),
    Sheet1_Sheet = Source{[Item="Sheet1",Kind="Sheet"]}[Data],
    #"Promoted Headers" = Table.PromoteHeaders(Sheet1_Sheet, [PromoteAllScalars=true]),
...
```m
let
    Quelle = Excel.Workbook(File.Contents("\\rolandberger.net\DFS\MUC\services4\bits\analytics_tools\02_Projects\dm 2021\02_Unterlagen\AT\07_Dashboard\Input\Segmente.xlsx"), null, true),
