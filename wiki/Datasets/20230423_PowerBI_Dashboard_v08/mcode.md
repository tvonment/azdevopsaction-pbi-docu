...
## Table: Marketing_Costs_Oeffentlichkeitsakt_20230503


```m
let
    Source = Csv.Document(File.Contents("C:\Users\M710216\Documents\3 - Projekte\b - extern\2023\20230411_MAN\01_Rproject_MAN\01_Data\13_Marketing\02_OutputDashboard\Marketing_Costs_Oeffentlichkeitsakt_20230503.csv"),[Delimiter=";", Columns=20, Encoding=1252, QuoteStyle=QuoteStyle.None]),
    #"Promoted Headers" = Table.PromoteHeaders(Source, [PromoteAllScalars=true]),
    #"Changed Type" = Table.TransformColumnTypes(#"Promoted Headers",{{"Kostenart", Int64.Type}, {"Partnerobjekt", type text}, {"Partnerobjektbezeichnung", type text}, {"Geschäftsjahr", Int64.Type}, {"Periode", Int64.Type}, {"Belegnummer", Int64.Type}, {"Buchungszeile", Int64.Type}, {"Kostenstelle", type text}, {"B/Entlastungskennz.", type text}, {"Buchungsdatum", type date}, {"Belegart", type text}, {"Wert/KWähr", type number}, {"K.Währung", type text}, {"Ressort", type text}, {"Gesellschaft", type text}, {"Quelle", type text}, {"TEXT", type text}, {"GROUP12_TEXT", type text}, {"GROUP11_TEXT", type text}, {"GROUPAGG_TEXT", type text}})
in
    #"Changed Type"
```
...
## Table: Marketing_Costs_bi_20230505


```m
let
    Source = Csv.Document(File.Contents("C:\Users\M710216\Documents\3 - Projekte\b - extern\2023\20230411_MAN\01_Rproject_MAN\01_Data\14_Vertrieb\04_Output_Dashboard\Marketing_Costs_bi_20230505.csv"),[Delimiter=";", Columns=58, Encoding=1252, QuoteStyle=QuoteStyle.None]),
    #"Promoted Headers" = Table.PromoteHeaders(Source, [PromoteAllScalars=true]),
    #"Changed Type" = Table.TransformColumnTypes(#"Promoted Headers",{{"KOSTENART", Int64.Type}, {"year", Int64.Type}, {"GESELLSCHAFT_ID", Int64.Type}, {"TYPE", type text}, {"TEXT", type text}, {"RESSORT", type text}, {"GESELLSCHAFT_TEXT", type text}, {"WAEHRUNG", type text}, {"VALUE_IST", type number}, {"VALUE_EUR_SIM", type number}, {"GROUP13", type text}, {"GROUP12", type text}, {"GROUP11", type text}, {"GROUP10", type text}, {"GROUP9", type text}, {"GROUP8", type text}, {"GROUP7", type text}, {"GROUP6", type text}, {"GROUP6_TEXT", type text}, {"GROUP7_TEXT", type text}, {"GROUP8_TEXT", type text}, {"GROUP9_TEXT", type text}, {"GROUP10_TEXT", type text}, {"GROUP11_TEXT", type text}, {"GROUP12_TEXT", type text}, {"GROUP13_TEXT", type text}, {"SOURCE", type text}, {"GROUPAGG", type text}, {"GROUPAGG_TEXT", type text}, {"RESSORT_mod", type text}, {"filter_kag", Int64.Type}, {"filter_ges", Int64.Type}, {"filter_bin", Int64.Type}, {"var_focus_1", Int64.Type}, {"var_focus_2", Int64.Type}, {"GROUPAGG_TEXT_group", type text}, {"var_adressable", Int64.Type}, {"bin_is_hq", Int64.Type}, {"RESSORT_mod_2", type text}, {"VALUE_UMSATZ", type number}, {"VALUE_UMSATZ_bin", Int64.Type}, {"VALUE_UMSATZ_GS", Int64.Type}, {"VALUE_UMSATZ_SHARE", type number}, {"VALUE_UMSATZ_SHARE_GS", Int64.Type}, {"VALUE_UMSATZ__bin_isvertrieb", Int64.Type}, {"Objekt", type text}, {"Objektbezeichnung", type text}, {"Kostenartenbeschr.", type text}, {"EinkBeleg", Int64.Type}, {"Bezeichnung des Gegenkontos", type text}, {"Per", Int64.Type}, {"RefBelegnr", type text}, {"Bezeichnung", type text}, {"Wert/OWähr", type number}, {"KWähr", type text}, {"Gegenkontobezeichnung", type text}, {"value_perc", type number}, {"value_perc_toBI", type number}})
in
    #"Changed Type"
```


## Table: ZP_Costs_bi_20230508


```m
let
    Source = Csv.Document(File.Contents("C:\Users\M710216\Documents\3 - Projekte\b - extern\2023\20230411_MAN\01_Rproject_MAN\01_Data\15_Produktion\01_ZP\04_Output_Dashboard\ZP_Costs_bi_20230508.csv"),[Delimiter=";", Columns=61, Encoding=1252, QuoteStyle=QuoteStyle.None]),
    #"Promoted Headers" = Table.PromoteHeaders(Source, [PromoteAllScalars=true]),
    #"Changed Type" = Table.TransformColumnTypes(#"Promoted Headers",{{"KOSTENART", Int64.Type}, {"year", Int64.Type}, {"GESELLSCHAFT_ID", Int64.Type}, {"TYPE", type text}, {"TEXT", type text}, {"RESSORT", type text}, {"GESELLSCHAFT_TEXT", type text}, {"WAEHRUNG", type text}, {"VALUE_IST", type number}, {"VALUE_EUR_SIM", type number}, {"GROUP13", type text}, {"GROUP12", type text}, {"GROUP11", type text}, {"GROUP10", type text}, {"GROUP9", type text}, {"GROUP8", type text}, {"GROUP7", type text}, {"GROUP6", type text}, {"GROUP6_TEXT", type text}, {"GROUP7_TEXT", type text}, {"GROUP8_TEXT", type text}, {"GROUP9_TEXT", type text}, {"GROUP10_TEXT", type text}, {"GROUP11_TEXT", type text}, {"GROUP12_TEXT", type text}, {"GROUP13_TEXT", type text}, {"SOURCE", type text}, {"GROUPAGG", type text}, {"GROUPAGG_TEXT", type text}, {"RESSORT_mod", type text}, {"filter_kag", Int64.Type}, {"filter_ges", Int64.Type}, {"filter_bin", Int64.Type}, {"var_focus_1", Int64.Type}, {"var_focus_2", Int64.Type}, {"GROUPAGG_TEXT_group", type text}, {"var_adressable", Int64.Type}, {"bin_is_hq", Int64.Type}, {"RESSORT_mod_2", type text}, {"VALUE_UMSATZ", Int64.Type}, {"VALUE_UMSATZ_bin", Int64.Type}, {"VALUE_UMSATZ_GS", Int64.Type}, {"VALUE_UMSATZ_SHARE", type number}, {"VALUE_UMSATZ_SHARE_GS", Int64.Type}, {"VALUE_UMSATZ__bin_isvertrieb", Int64.Type}, {"Objekt", type text}, {"Partner-Auftrag", type text}, {"Partnerobjektbezeichnung", type text}, {"Kostenartenbeschr.", type text}, {"Periode", Int64.Type}, {"Belegdatum", type date}, {"Buchungsdatum", type date}, {"Wert/KWähr", type number}, {"K.Währung", type text}, {"Benutzername", type text}, {"Bestelltext", type text}, {"Beschreibung des Gegenkontos", type text}, {"Einkaufsbeleg", Int64.Type}, {"einmalig/ wiederkehrend", type text}, {"value_perc_toBI", type number}, {"RESSORT_prod", type text}})
in
    #"Changed Type"
```


## Table: ZP_Costs_bi_20230509


```m
let
    Source = Csv.Document(File.Contents("C:\Users\M710216\Documents\3 - Projekte\b - extern\2023\20230411_MAN\01_Rproject_MAN\01_Data\15_Produktion\01_ZP\04_Output_Dashboard\ZP_Costs_bi_20230509.csv"),[Delimiter=";", Columns=62, Encoding=1252, QuoteStyle=QuoteStyle.None]),
    #"Promoted Headers" = Table.PromoteHeaders(Source, [PromoteAllScalars=true]),
    #"Changed Type" = Table.TransformColumnTypes(#"Promoted Headers",{{"KOSTENART", Int64.Type}, {"year", Int64.Type}, {"GESELLSCHAFT_ID", Int64.Type}, {"TYPE", type text}, {"TEXT", type text}, {"RESSORT", type text}, {"GESELLSCHAFT_TEXT", type text}, {"WAEHRUNG", type text}, {"VALUE_IST", type number}, {"VALUE_EUR_SIM", type number}, {"GROUP13", type text}, {"GROUP12", type text}, {"GROUP11", type text}, {"GROUP10", type text}, {"GROUP9", type text}, {"GROUP8", type text}, {"GROUP7", type text}, {"GROUP6", type text}, {"GROUP6_TEXT", type text}, {"GROUP7_TEXT", type text}, {"GROUP8_TEXT", type text}, {"GROUP9_TEXT", type text}, {"GROUP10_TEXT", type text}, {"GROUP11_TEXT", type text}, {"GROUP12_TEXT", type text}, {"GROUP13_TEXT", type text}, {"SOURCE", type text}, {"GROUPAGG", type text}, {"GROUPAGG_TEXT", type text}, {"RESSORT_mod", type text}, {"filter_kag", Int64.Type}, {"filter_ges", Int64.Type}, {"filter_bin", Int64.Type}, {"var_focus_1", Int64.Type}, {"var_focus_2", Int64.Type}, {"GROUPAGG_TEXT_group", type text}, {"var_adressable", Int64.Type}, {"bin_is_hq", Int64.Type}, {"RESSORT_mod_2", type text}, {"VALUE_UMSATZ", Int64.Type}, {"VALUE_UMSATZ_bin", Int64.Type}, {"VALUE_UMSATZ_GS", Int64.Type}, {"VALUE_UMSATZ_SHARE", type number}, {"VALUE_UMSATZ_SHARE_GS", Int64.Type}, {"VALUE_UMSATZ__bin_isvertrieb", Int64.Type}, {"Objekt", type text}, {"Kostenstellenbezeichung", type text}, {"Partner-Auftrag", type text}, {"Partnerobjektbezeichnung", type text}, {"Kostenartenbeschr.", type text}, {"Periode", Int64.Type}, {"Belegdatum", type date}, {"Buchungsdatum", type date}, {"Wert/KWähr", type number}, {"K.Währung", type text}, {"Benutzername", type text}, {"Bestelltext", type text}, {"Beschreibung des Gegenkontos", type text}, {"Einkaufsbeleg", Int64.Type}, {"einmalig/ wiederkehrend", type text}, {"value_perc_toBI", type number}, {"RESSORT_prod", type text}})
in
    #"Changed Type"
```
