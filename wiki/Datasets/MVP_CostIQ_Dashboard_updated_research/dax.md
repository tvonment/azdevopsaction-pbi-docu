...
```dax
calc_current_month_year = FORMAT ( TODAY(), "mmm YYYY" )
```
...
return 
    IF(contract="Spot", spot_month, 
        IF(contract="M1", FORMAT(m1_month, "mmmm yyyy"),
            IF(contract="M2", FORMAT(m2_month, "mmmm yyyy"), 
                IF(contract="M3", FORMAT(m3_month, "mmmm yyyy"),
                    IF(contract="M4", FORMAT(m4_month, "mmmm yyyy"))))))
```
