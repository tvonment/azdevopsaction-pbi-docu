...
```m
let
    Quelle = Excel.Workbook(File.Contents("C:\Users\M800503\Roland Berger Holding GmbH\ENBW - Wachstumsplattform Wind Onshore - General\06_Phase 2E\03_Neue Priorisierungslogik\01_Regeliterationen\09_September_Iteration\2_Schieberegler\230905_Schieberegler_Sep_v31.xlsx"), null, true),
...
let
    ...
    #"Sortierte Zeilen" = Table.Sort(#"Geänderter Typ",{{"Projektname", Order.Ascending}}),
