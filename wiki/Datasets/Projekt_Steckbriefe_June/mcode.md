...
let
    ...
    #"Entfernte Fehler" = Table.RemoveRowsWithErrors(#"Geänderter Typ", {"Wirt_comment_1"}),
    #"Entfernte Fehler1" = Table.RemoveRowsWithErrors(#"Entfernte Fehler", {"Pl_comment_1"})
in
    #"Entfernte Fehler1"
```
