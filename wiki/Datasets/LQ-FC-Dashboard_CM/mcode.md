...
let
    ...
    #"Filtered Plan Variant" = Table.SelectRows(dbo_V_DW_LIP_DATA_SUM, each [PLAN_VARIANT_ID] > 120),
    ...
    #"Filtered Rows1" = Table.SelectRows(#"Removed Columns1", each ([IS_CURRENCY_DETAIL_SUM] = true))
in
    #"Filtered Rows1"
```
...
let
    ...
    #"Inserted Day of Week" = Table.AddColumn(#"Removed Columns1", "Day of Week", each Date.DayOfWeek([Date]), Int64.Type),
    #"Reordered Columns2" = Table.ReorderColumns(#"Inserted Day of Week",{"Date", "Year", "Month", "Day of Week", "Week of Year", "Date_short", "Year_adj", "Date_sort", "Year_CW", "Week_of_Year_Interim", "Calendar Week", "Y-CW_long"})
in
    #"Reordered Columns2"
```
...
let
    ...
    #"Inserted Day Name" = Table.AddColumn(#"Changed Type", "Day Name", each Date.DayOfWeekName([VALUE_DATE]), type text),
    #"Inserted Week of Year" = Table.AddColumn(#"Inserted Day Name", "Week of Year", each Date.WeekOfYear([VALUE_DATE]), Int64.Type),
    #"Filtered Rows1" = Table.SelectRows(#"Inserted Week of Year", each true),
    #"Merged Queries" = Table.NestedJoin(#"Filtered Rows1", {"CLIENT_SHORT_NAME"}, RB_COMPANIES, {"ORGANIZATIONAL_CCENTER_ID"}, "RB_COMPANIES", JoinKind.LeftOuter),
    #"Expanded RB_COMPANIES" = Table.ExpandTableColumn(#"Merged Queries", "RB_COMPANIES", {"COUNTRY_ISO3"}, {"RB_COMPANIES.COUNTRY_ISO3"})
in
    #"Expanded RB_COMPANIES"
```
...
let
    ...
    #"Last day of FC" = Table.AddColumn(Source_date, "Custom.1", each List.Dates([PLAN_START], 110, #duration(1, 0, 0, 0))),
...
let
    ...
    dbo_V_COPS_LIP_CARDINAL_IMPORT = Corima{[Schema="dbo",Item="V_COPS_LIP_CARDINAL_IMPORT"]}[Data]
in
    dbo_V_COPS_LIP_CARDINAL_IMPORT
```
