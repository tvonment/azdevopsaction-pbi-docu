...
let
    ...
    #"Changed Type" = Table.TransformColumnTypes(#"Promoted Headers",{{"Project #", Int64.Type}, {"Project", type text}, {"Start", type date}, {"End", type date}, {"Progress", Percentage.Type}, {"Progress Target", Percentage.Type}, {"Progress Status", type number}}),
...
let
    ...
    #"Removed Columns" = Table.RemoveColumns(TaskLog_Sheet,{"Column1"}),
    ...
    #"Changed Type" = Table.TransformColumnTypes(#"Promoted Headers",{{"#", Int64.Type}, {"Status", type text}, {"Responsible", type text}, {"SDAIA iDART AD", type text}, {"Entity", type text},{"Project", type text}, {"Topic", type text}, {"Task Description", type text}, {"Entry Date", type date}, {"Due date", type date}, {"Updated Due Date", type date}, {"Closing date", type date}, {"Comments", type text}}),
...
let
    Source = Excel.Workbook(File.Contents("C:\Users\m800177\Roland Berger Holding GmbH\SCAI_Sawaher - 70_Reporting\Nina's Work\Input Data.xlsx"), null, true),
    Milestone_Sheet = Source{[Item="Milestone",Kind="Sheet"]}[Data],
    #"Promoted Headers" = Table.PromoteHeaders(Milestone_Sheet, [PromoteAllScalars=true]),
    #"Changed Type" = Table.TransformColumnTypes(#"Promoted Headers",{{"Milestone #", type text}, {"Milestone", type text}, {"Task #", type text}, {"Due Date", type date}, {"Responsible", type text}, {"Cause of Delay", type text}, {"Milestone Status", type text}})
in
    #"Changed Type"
```
