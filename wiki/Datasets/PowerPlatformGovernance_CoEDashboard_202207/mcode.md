...
|Dataset|[PowerPlatformGovernance_CoEDashboard_202207](./../PowerPlatformGovernance_CoEDashboard_202207.md)|
| :--- | :--- |
...
then 1 
    ...
    #"Added Custom2" = Table.AddColumn(#"Removed Columns", "IsNotCurrentMonth", each if [admin_applastlaunchedon] = null then true else if Date.IsInCurrentMonth([admin_applastlaunchedon]) then false else false),
    #"Added Custom3" = Table.AddColumn(#"Added Custom2", "IsInCurrentQuarter", each if [admin_applastlaunchedon] = null then false else if Date.IsInCurrentQuarter([admin_applastlaunchedon]) then true else false)
in
    #"Added Custom3"
```
...
let
    ...
    #"Expanded Maker" = Table.ExpandTableColumn(#"Merged Queries", "Maker", {"admin_city"}, {"admin_city.1"}),
