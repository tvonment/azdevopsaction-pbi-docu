...
|Dataset|[MVP_CostIQ_Dashboard_updated_5_AZ](./../MVP_CostIQ_Dashboard_updated_5_AZ.md)|
| :--- | :--- |
...
```m
let
    Source = AzureStorage.Blobs("https://powerbistoresawprodv1.blob.core.windows.net/2023-03-cost-iq-purchase-opt"),
    #"Sorted Rowss" = Table.Sort(Source,{{"Date modified", Order.Descending}}),
    Simulation_output = #"Sorted Rowss"{[Name="Raw_materials_output.xlsx",#"Folder Path"="https://powerbistoresawprodv1.blob.core.windows.net/2023-03-cost-iq-purchase-opt"]}[Content],
...
let
    ...
    Simulation_output = #"Sorted Rows"{[Name="Raw_materials_output.xlsx",#"Folder Path"="https://powerbistoresawprodv1.blob.core.windows.net/2023-03-cost-iq-purchase-opt"]}[Content],
    #"Imported Excel Workbook" = Excel.Workbook(#"Simulation_output"),
...
let
    Source = AzureStorage.Blobs("https://powerbistoresawprodv1.blob.core.windows.net/2023-03-cost-iq-purchase-opt"),
    #"Sorted Rowss" = Table.Sort(Source,{{"Date modified", Order.Descending}}),
    Simulation_output = #"Sorted Rowss"{[Name="Simulation_output.xlsx",#"Folder Path"="https://powerbistoresawprodv1.blob.core.windows.net/2023-03-cost-iq-purchase-opt"]}[Content],
    #"Imported Excel Workbook" = Excel.Workbook(#"Simulation_output"),
