...
```dax
CW = LOOKUPVALUE(ZZ_RollingCalender[Year_CW_long], ZZ_RollingCalender[Date], FC_DATA[PERIODE_DATE])
```
...
FC_Amount_acc_RFC = calculate( 
                    [FC_Amount_RFC], 
                            filter (ALLSELECTED(FC_DATA), FC_DATA[YearWeekOfYear(LeadingZero)] <= max(FC_DATA[YearWeekOfYear(LeadingZero)]) && FC_DATA[PLAN_VARIANT_ID] = max(FC_DATA[PLAN_VARIANT_ID]))
                        )
```
...
```dax
FC_CP_Balance_RFC_LFC_2022 = calculate(sum(FC_DATA[CONCERN_AMOUNT]),FC_DATA[CATEGORY_SHORT_NAME] = {"Cash Pool balance"}, FC_DATA[IS_CURRENCY_DETAIL_SUM] = {true}, FC_DATA[Weekbreak_ID] = {1},FC_DATA[ID_Last_FC] = {1}, FC_DATA[Year] = {2022})
```
...
```dax
FC_ACTUAL_LAST_DELTA_RFC_m = 
        (
            calculate(sum(FC_ACTUALS[CONCERN_AMOUNT]),FC_ACTUALS[Last_Actuals_ID]) 
            -
...
```dax
FC_Incremental_Last = [FC_Amount_RFC_Last_Delta_m] + [FC_ACTUAL_LAST_DELTA_RFC_m]
```
...
```dax
FC_CP_Balance_RFC_LFC_2021 = calculate(sum(FC_DATA[CONCERN_AMOUNT]),FC_DATA[CATEGORY_SHORT_NAME] = {"Cash Pool balance"}, FC_DATA[IS_CURRENCY_DETAIL_SUM] = {true}, FC_DATA[Weekbreak_ID] = {1},FC_DATA[ID_Last_FC] = {1}, FC_DATA[Year] = {2021})
```
...
```dax
FC_Amount_Rolling = 
CALCULATE(IF(SELECTEDVALUE('ZZ_RollingCalendar_From_FC_Plans- For rolling CW'[Year_select]) = 2021, [FC_Amount_RFC], [FC_Amount_Y2_2022])
)
```
...
SWITCH(
    TRUE(),
    [User Selection] = "NLD (64000000)", [FC_CP_Balance_2021],
    [User Selection] = "FRA (45000000)", [FC_CP_Balance_2021],
    [User Selection] = "BEL (35000000)", [FC_CP_Balance_2021],
    [User Selection] = "ITA (55000000)", [FC_CP_Balance_2021], 
    [User Selection] = "AUT (65000000)", [FC_CP_Balance_2021],
    [User Selection] = "ESP (80000000)", [FC_CP_Balance_2021],
    [User Selection] = "PRT (70000000)", [FC_CP_Balance_2021],
    [FC_AvLQ_Y1_2021]
    )
```
...
```dax
FC_AvLQ_RFC_LFC_2022 = 
calculate(sum(FC_DATA[CONCERN_AMOUNT]),FC_DATA[CATEGORY_SHORT_NAME] = {"available liquidity"}, FC_DATA[IS_CURRENCY_DETAIL_SUM] = {true},FC_DATA[Year] = {2022}, FC_DATA[Weekbreak_ID] = {1}, FC_DATA[ID_Last_FC] = {1})
```



```dax
FC_AvLQ_Y2_2022 = calculate(sum(FC_DATA[CONCERN_AMOUNT]),FC_DATA[CATEGORY_SHORT_NAME] = {"available liquidity"}, FC_DATA[IS_CURRENCY_DETAIL_SUM] = {true},FC_DATA[Year] = {2022}, FC_DATA[Weekbreak_ID] = {1},FC_DATA[ID_Current_FC] = {1})
```



```dax
FC_CP_Balance_2022 = calculate(sum(FC_DATA[CONCERN_AMOUNT]),FC_DATA[CATEGORY_SHORT_NAME] = {"Cash Pool balance"}, FC_DATA[IS_CURRENCY_DETAIL_SUM] = {true}, FC_DATA[Weekbreak_ID] = {1},FC_DATA[ID_Current_FC] = {1},FC_DATA[Year] = {2022})
```



```dax
FC_AvLQ_Y1_2021 = calculate(sum(FC_DATA[CONCERN_AMOUNT]),FC_DATA[CATEGORY_SHORT_NAME] = {"available liquidity"}, FC_DATA[IS_CURRENCY_DETAIL_SUM] = {true},FC_DATA[Year] = {2021}, FC_DATA[Weekbreak_ID] = {1},FC_DATA[ID_Current_FC] = {1})
```



```dax
FC_CP_Balance_2021 = calculate(sum(FC_DATA[CONCERN_AMOUNT]),FC_DATA[CATEGORY_SHORT_NAME] = {"Cash Pool balance"}, FC_DATA[IS_CURRENCY_DETAIL_SUM] = {true}, FC_DATA[Year] = {2021},FC_DATA[Weekbreak_ID] = {1},FC_DATA[ID_Current_FC] = {1})
```



```dax
CP_FC_AvLQ_RFC_LFC_S_Y1_2021 = 
SWITCH(
    	TRUE(),
    [User Selection] = "NLD (64000000)", [FC_CP_Balance_RFC_LFC_2021],
    [User Selection] = "FRA (45000000)", [FC_CP_Balance_RFC_LFC_2021],
    [User Selection] = "BEL (35000000)", [FC_CP_Balance_RFC_LFC_2021],
    [User Selection] = "ITA (55000000)", [FC_CP_Balance_RFC_LFC_2021], 
    [User Selection] = "AUT (65000000)", [FC_CP_Balance_RFC_LFC_2021],
    [User Selection] = "ESP (80000000)", [FC_CP_Balance_RFC_LFC_2021],
    [User Selection] = "PRT (70000000)", [FC_CP_Balance_RFC_LFC_2021],
    [FC_AvLQ_RFC_LFC_2021]
    )
```
...
```dax
FC_AvLQ_RFC_LFC_2021 = 
calculate(sum(FC_DATA[CONCERN_AMOUNT]),FC_DATA[CATEGORY_SHORT_NAME] = {"available liquidity"}, FC_DATA[IS_CURRENCY_DETAIL_SUM] = {true},FC_DATA[Year] = {2021}, FC_DATA[Weekbreak_ID] = {1}, FC_DATA[ID_Last_FC] = {1})
```
...
```dax
LQ Delta = ABS([CP_AvLQ_2021_S]-[CP_FC_AvLQ_Y1_2021])
```
...
```dax
Delta_LQ_Actual_FC Start = ABS([CP_AvLQ_2022_S]- [CP_FC_AvLQ_Y2_2022])
```
...
```dax
Delta_LQ_Actual_FC Start_LC = ABS([CP_AvLQ_2022_S_LC]- [CP_FC_AvLQ_Y1_2022_LC])
```
...
```dax
FC_AvLQ_Y1_2022_LC = calculate(sum(FC_DATA[AMOUNT]),FC_DATA[CATEGORY_SHORT_NAME] = {"available liquidity"}, FC_DATA[IS_CURRENCY_DETAIL_SUM] = {true},FC_DATA[Year] = {2022}, FC_DATA[Weekbreak_ID] = {1},FC_DATA[ID_Current_FC] = {1})
```



```dax
CP_FC_AvLQ_Y1_2022_LC = 
SWITCH(
    TRUE(),
    [User Selection] = "NLD (64000000)", [FC_CP_Balance_2022],
    [User Selection] = "FRA (45000000)", [FC_CP_Balance_2022],
...
```dax
FC_Amount_LFC_for_FC over FC = If( SELECTEDVALUE('ZZ_RollingCalendar for FC over FC with Last Actual week'[Week of Year] )< WEEKNUM(TODAY()),[FC_AmountLastweek_LFC], [FC_Amount_RFC_LFC_Overlapping])
```
...
If( SELECTEDVALUE('ZZ_RollingCalendar for FC over FC with Last Actual week'[Week of Year] )< WEEKNUM(TODAY()),[Actual_Last_week], [FC_Amount_Rolling])
...
FC_ACTUAL_2ndLAST_DELTA_RFC_m = 
        (
            calculate(sum(FC_ACTUALS[CONCERN_AMOUNT]),FC_ACTUALS[2ndLast_Actuals_ID]) 
            -
...
FC_ACTUAL_3ndLAST_DELTA_RFC_m = 
        (
            calculate(sum(FC_ACTUALS[CONCERN_AMOUNT]),FC_ACTUALS[3rdLast_Actuals_ID]) 
            -
...
```dax
FC_ACTUAL_4thLAST_DELTA_RFC_m = 
        (
            calculate(sum(FC_ACTUALS[CONCERN_AMOUNT]),FC_ACTUALS[4thLast_Actuals_ID]) 
            -
...
FC_ACTUAL_5thLAST_DELTA_RFC_m = 
        (
            calculate(sum(FC_ACTUALS[CONCERN_AMOUNT]),FC_ACTUALS[5thLast_Actuals_ID]) 
            -
...
```dax
CIB 2020 = calculate(sum(ACTUAL_BALANCES[TOTAL_SUM_EUR]),ACTUAL_BALANCES[Year] = {2020}, ACTUAL_BALANCES[Day of Week] = {1}, ACTUAL_BALANCES[TOTAL_SUM_EUR] > 0)
```



```dax
CIB 2019 = calculate(sum(ACTUAL_BALANCES[TOTAL_SUM_EUR]),ACTUAL_BALANCES[Year] = {2019}, ACTUAL_BALANCES[Day of Week] = {1}, ACTUAL_BALANCES[TOTAL_SUM_EUR] > 0)
```



```dax
CIB 2021 = calculate(sum(ACTUAL_BALANCES[TOTAL_SUM_EUR]), ACTUAL_BALANCES[Day of Week] = {1}, ACTUAL_BALANCES[TOTAL_SUM_EUR] > 0, FILTER(ACTUAL_BALANCES,ACTUAL_BALANCES[DATUM] >= Date(2021,01,04) && ACTUAL_BALANCES[DATUM] <= Date(2022,01,02 )))
```



```dax
CIB = calculate(sum(ACTUAL_BALANCES[TOTAL_SUM_EUR]), ACTUAL_BALANCES[TOTAL_SUM_EUR] > 0)
```



```dax
Credit_Line_Usage 2021 = calculate(sum(ACTUAL_BALANCES[TOTAL_SUM_EUR]), ACTUAL_BALANCES[Day of Week] = {1}, ACTUAL_BALANCES[TOTAL_SUM_EUR] < 0, FILTER(ACTUAL_BALANCES,ACTUAL_BALANCES[DATUM] >= Date(2021,01,04) && ACTUAL_BALANCES[DATUM] <= Date(2022,01,02 )))
```



```dax
Credit_Line_Usage 2020 = calculate(sum(ACTUAL_BALANCES[TOTAL_SUM_EUR]),ACTUAL_BALANCES[Year] = {2020}, ACTUAL_BALANCES[Day of Week] = {1}, ACTUAL_BALANCES[TOTAL_SUM_EUR] < 0)
```



```dax
Credit_Line_Usage 2019 = calculate(sum(ACTUAL_BALANCES[TOTAL_SUM_EUR]),ACTUAL_BALANCES[Year] = {2019}, ACTUAL_BALANCES[Day of Week] = {1}, ACTUAL_BALANCES[TOTAL_SUM_EUR] < 0)
```



```dax
Credit line usage = calculate(sum(ACTUAL_BALANCES[TOTAL_SUM_EUR]), ACTUAL_BALANCES[TOTAL_SUM_EUR] < 0)
```
...
```dax
CIB_Graph = if( isblank(calculate(sum(ACTUAL_BALANCES[TOTAL_SUM_EUR]), ACTUAL_BALANCES[TOTAL_SUM_EUR] > 0)), 0, calculate(sum(ACTUAL_BALANCES[TOTAL_SUM_EUR]), ACTUAL_BALANCES[TOTAL_SUM_EUR] > 0))
```
...
```dax
Credit Line = CALCULATE(sum('RB_RoW Credit Lines'[Amount_EUR]))
```
...
```dax
Credit Line_2019 = CALCULATE(sum('RB_RoW Credit Lines'[Amount_EUR]),'RB_RoW Credit Lines'[Year] = {2019}, 'RB_RoW Credit Lines'[Day of Week] = {6})
```



```dax
Credit Line_2020 = CALCULATE(sum('RB_RoW Credit Lines'[Amount_EUR]),'RB_RoW Credit Lines'[Year] = {2020}, 'RB_RoW Credit Lines'[Day of Week] = {6})
```



```dax
Credit Line_2021 = CALCULATE(sum('RB_RoW Credit Lines'[Amount_EUR]), 'RB_RoW Credit Lines'[Day of Week] = {6}, FILTER('RB_RoW Credit Lines','RB_RoW Credit Lines'[Date] >= Date(2021,01,04) && 'RB_RoW Credit Lines'[Date] <= Date(2022,01,02 )))
```
...
```dax
CIB 2022 = calculate(sum(ACTUAL_BALANCES[TOTAL_SUM_EUR]),ACTUAL_BALANCES[Year] = {2022}, ACTUAL_BALANCES[Day of Week] = {1}, ACTUAL_BALANCES[TOTAL_SUM_EUR] > 0)
```



```dax
Credit Line_2022 = CALCULATE(sum('RB_RoW Credit Lines'[Amount_EUR]),'RB_RoW Credit Lines'[Year] = {2022}, 'RB_RoW Credit Lines'[Day of Week] = {6})
```



```dax
Credit_Line_Usage 2022 = calculate(sum(ACTUAL_BALANCES[TOTAL_SUM_EUR]),ACTUAL_BALANCES[Year] = {2022}, ACTUAL_BALANCES[Day of Week] = {1}, ACTUAL_BALANCES[TOTAL_SUM_EUR] < 0)
```
...
```dax
CIB 2021_LC = calculate(sum(ACTUAL_BALANCES[TOTAL_SUM]),ACTUAL_BALANCES[Year] = {2021}, ACTUAL_BALANCES[Day of Week] = {1}, ACTUAL_BALANCES[TOTAL_SUM_EUR] > 0)
```
...
```dax
Credit Line_2021_LC = CALCULATE(sum('RB_RoW Credit Lines'[Amount]),'RB_RoW Credit Lines'[Year] = {2021}, 'RB_RoW Credit Lines'[Day of Week] = {6})
```



```dax
Credit_Line_Usage 2021_LC = calculate(sum(ACTUAL_BALANCES[TOTAL_SUM]),ACTUAL_BALANCES[Year] = {2021}, ACTUAL_BALANCES[Day of Week] = {1}, ACTUAL_BALANCES[TOTAL_SUM] < 0)
```
...
```dax
CIB 2022_LC = calculate(sum(ACTUAL_BALANCES[TOTAL_SUM]),ACTUAL_BALANCES[Year] = {2022}, ACTUAL_BALANCES[Day of Week] = {1}, ACTUAL_BALANCES[TOTAL_SUM_EUR] > 0)
```



```dax
Credit Line_2022_LC = CALCULATE(sum('RB_RoW Credit Lines'[Amount]),'RB_RoW Credit Lines'[Year] = {2022}, 'RB_RoW Credit Lines'[Day of Week] = {6})
```



```dax
Credit_Line_Usage 2022_LC = calculate(sum(ACTUAL_BALANCES[TOTAL_SUM]),ACTUAL_BALANCES[Year] = {2022}, ACTUAL_BALANCES[Day of Week] = {1}, ACTUAL_BALANCES[TOTAL_SUM] < 0)
```



```dax
AvLQ_2022_LC = [CIB 2022_LC] + [Credit Line_2022_LC] + [Credit_Line_Usage 2022_LC]
```
...
```dax
Last_Actuals_ID = if ( max(FC_ACTUALS[VALUE_DATE]) -14 < FC_ACTUALS[VALUE_DATE], 1, 0) - FC_ACTUALS[Current_Actuals_ID]
```



```dax
2ndLast_Actuals_ID = if ( max(FC_ACTUALS[VALUE_DATE]) -21 < FC_ACTUALS[VALUE_DATE], 1, 0) - FC_ACTUALS[Last_Actuals_ID]
```



```dax
3rdLast_Actuals_ID = if ( max(FC_ACTUALS[VALUE_DATE]) -28 < FC_ACTUALS[VALUE_DATE], 1, 0) - FC_ACTUALS[2ndLast_Actuals_ID]
```



```dax
4thLast_Actuals_ID = if ( max(FC_ACTUALS[VALUE_DATE]) -35 < FC_ACTUALS[VALUE_DATE], 1, 0) - FC_ACTUALS[3rdLast_Actuals_ID]
```



```dax
5thLast_Actuals_ID = if ( max(FC_ACTUALS[VALUE_DATE]) -42 < FC_ACTUALS[VALUE_DATE], 1, 0) - FC_ACTUALS[4thLast_Actuals_ID]
```
...
```dax
Supplier = calculate(sum(FC_ACTUALS[CONCERN_AMOUNT]), FC_ACTUALS[CATEGORY_SHORT_NAME] = "Supplier")
```
