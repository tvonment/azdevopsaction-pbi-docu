...
|Dataset|[2023 Acquisition Performance](./../2023-Acquisition-Performance.md)|
| :--- | :--- |
...
let
    ...
    #"Merged Queries" = Table.NestedJoin(#"Removed Duplicates", {"ProjectNumber"}, #"rep v_fc_acp_project_data", {"project_number"}, "rep v_acp_fc_project_data", JoinKind.LeftOuter),
...
```m
2023 meta [IsParameterQuery=true, Type="Number", IsParameterQueryRequired=true]
```
