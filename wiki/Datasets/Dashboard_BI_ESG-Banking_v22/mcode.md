...
|Dataset|[Dashboard_BI_ESG-Banking_v22](./../Dashboard_BI_ESG-Banking_v22.md)|
| :--- | :--- |
...
let
    ...
    #"Replaced Value" = Table.ReplaceValue(#"Changed Type",null,"N/A",Replacer.ReplaceValue,{"Description"})
in
    #"Replaced Value"
```
...
let
    ...
    #"Added Custom" = Table.AddColumn(#"Changed Type", "Source", each Text.Lower(List.RemoveMatchingItems(Text.Split(Text.Replace([url],"://","/"),"/"),{"https","http","www"},Comparer.OrdinalIgnoreCase){0}))
in
    #"Added Custom"
```
...
```m
let
    Source = Excel.Workbook(File.Contents("C:\Users\M712715\Roland Berger Holding GmbH\Thinkers AI & RB Workspace - General\04_Development\Data\df_credit_portfolio_v2.xlsx"), null, true),
    df_credit_portfolio_Sheet = Source{[Item="df_credit_portfolio",Kind="Sheet"]}[Data],
    #"Promoted Headers" = Table.PromoteHeaders(df_credit_portfolio_Sheet, [PromoteAllScalars=true]),
    #"Changed Type" = Table.TransformColumnTypes(#"Promoted Headers",{{"Asset class", type text}, {"Data Quality Rating", Int64.Type}, {"Jahr", Int64.Type}, {"Year", Int64.Type}, {"Land", type text}, {"Country", type text}, {"Branche", type text}, {"Bezeichnung", type text}, {"DarlehenID", Int64.Type}, {"Umsatz[€]", type number}, {"Saldo[€]", type number}, {"Bilanzsumme[€]", type number}, {"Anteil[%]", type number}, {"Scope 1-Intensität", type number}, {"Scope 2-Intensität", type number}, {"Scope 3-Intensität", type number}, {"Gesamtintensität", type number}, {"Scope 1-Emissionen[tCO2e]", type number}, {"Scope 2-Emissionen[tCO2e]", type number}, {"Scope 3-Emissionen[tCO2e]", type number}, {"Summe Emissionen[tCO2e]", type number}, {"Finanzierte Scope 1-Emissionen[tCO2e]", type number}, {"Finanzierte Scope 2-Emissionen[tCO2e]", type number}, {"Finanzierte Scope 3-Emissionen[tCO2e]", type number}, {"Summe finanzierte Emissionen[tCO2e]", type number}, {"Financed_Emission_Share", type number}, {"Saldo_Share", type number}})
in
    #"Changed Type"
```


## Table: df_credit_portfolio_Timeseries


```m
let
    Source = Excel.Workbook(File.Contents("C:\Users\M712715\Roland Berger Holding GmbH\Thinkers AI & RB Workspace - General\04_Development\Data\df_credit_portfolio_Timeseries.xlsx"), null, true),
    df_credit_portfolio_Timeseries_Sheet = Source{[Item="df_credit_portfolio_Timeseries",Kind="Sheet"]}[Data],
    #"Promoted Headers" = Table.PromoteHeaders(df_credit_portfolio_Timeseries_Sheet, [PromoteAllScalars=true]),
    #"Changed Type" = Table.TransformColumnTypes(#"Promoted Headers",{{"Bezeichnung", type text}, {"Jahr", Int64.Type}, {"idx", Int64.Type}, {"Asset class", type text}, {"Data Quality Rating", Int64.Type}, {"Year", Int64.Type}, {"Land", type text}, {"Country", type text}, {"Branche", type text}, {"DarlehenID", Int64.Type}, {"Umsatz[€]", type number}, {"Saldo[€]", type number}, {"Bilanzsumme[€]", type number}, {"Anteil[%]", type number}, {"Scope 1-Intensität", type number}, {"Scope 2-Intensität", type number}, {"Scope 3-Intensität", type number}, {"Gesamtintensität", type number}, {"Scope 1-Emissionen[tCO2e]", type number}, {"Scope 2-Emissionen[tCO2e]", type number}, {"Scope 3-Emissionen[tCO2e]", type number}, {"Summe Emissionen[tCO2e]", type number}, {"Finanzierte Scope 1-Emissionen[tCO2e]", type number}, {"Finanzierte Scope 2-Emissionen[tCO2e]", type number}, {"Finanzierte Scope 3-Emissionen[tCO2e]", type number}, {"Summe finanzierte Emissionen[tCO2e]", type number}, {"Financed_Emission_Share", type number}, {"Saldo_Share", type number}, {"Financed CO2 emissions to loan balance [tCO2/EUR Mio]", type number}, {"Summe finanzierte Emissionen[tCO2e]_lag", type number}, {"Saldo[€]_lag", type number}, {"Financed CO2 emissions to loan balance [tCO2/EUR Mio]_lag", type number}, {"Development_Summe finanzierte Emissionen[tCO2e]", type number}, {"Development_Financed CO2 emissions to loan balance [tCO2/EUR Mio]", type number}})
in
    #"Changed Type"
```
